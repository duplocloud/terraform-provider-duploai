...
terraform import duploai_config_map.app WORKSPACE_ID/CONFIG_MAP_ID
# Example:
# terraform import duploai_config_map.app 69b2aa30675718845bfe87a0/6a2258e94703bc957a1b824e
