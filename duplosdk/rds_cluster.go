...
// AWS RDS cluster API endpoint — the single source of truth for this resource's
...
func init() {
	const base = "/v1/aiservicedesk/user/data/workspaces/{workspace_id}/environment/AWSRdsClusters"

	RegisterEndpoint("rds_cluster", Endpoint{
		UriBase: base,
