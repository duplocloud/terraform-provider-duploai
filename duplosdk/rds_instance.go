...
// AWS RDS instance API endpoint — the single source of truth for this resource's
...
func init() {
	const base = "/v1/aiservicedesk/user/data/workspaces/{workspace_id}/environment/AWSRdsInstances"

	RegisterEndpoint("rds_instance", Endpoint{
		UriBase: base,
