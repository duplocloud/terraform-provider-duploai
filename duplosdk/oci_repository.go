...
// Kubernetes OCI repository (Flux OCIRepository) API endpoint — the single
// source of truth for this resource's URIs and verbs. The Terraform schema
// lives in the JSON spec.
func init() {
	const base = "/v1/aiservicedesk/user/data/workspaces/{workspace_id}/environment/K8sOCIRepositories"

	RegisterEndpoint("oci_repository", Endpoint{
		UriBase: base,
